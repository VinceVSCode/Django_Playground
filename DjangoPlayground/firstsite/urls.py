...
urlpatterns = [
    ...
    # Signup only. Login/logout/password views are provided by the project urlconf
    # (accounts/ -> CustomLoginView + django.contrib.auth.urls). Defining them here
    # too created a second 'login' route that shadowed CustomLoginView. See wiki T-02.
